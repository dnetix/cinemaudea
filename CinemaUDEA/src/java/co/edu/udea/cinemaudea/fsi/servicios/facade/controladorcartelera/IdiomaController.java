...
import co.edu.udea.cinemaudea.fsi.negocio.documentacion.IdiomaFacade;
...
public class IdiomaController implements Serializable {
    ...
    @EJB
    private co.edu.udea.cinemaudea.fsi.negocio.documentacion.IdiomaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("IdiomaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("IdiomaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("IdiomaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
