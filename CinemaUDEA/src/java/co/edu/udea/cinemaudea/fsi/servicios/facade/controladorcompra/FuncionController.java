package co.edu.udea.cinemaudea.fsi.servicios.facade.controladorcompra;
...
import co.edu.udea.cinemaudea.fsi.negocio.compra.FuncionFacade;
...
public class FuncionController implements Serializable {
    ...
    @EJB
    private co.edu.udea.cinemaudea.fsi.negocio.compra.FuncionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("FuncionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("FuncionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("FuncionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
