...
import co.edu.udea.cinemaudea.fsi.persistencia.entidades.Sala;
...
import co.edu.udea.cinemaudea.fsi.negocio.reserva.SalaFacade;
...
public class SalaController implements Serializable {
    ...
    @EJB
    private co.edu.udea.cinemaudea.fsi.negocio.reserva.SalaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("SalaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("SalaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("SalaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
