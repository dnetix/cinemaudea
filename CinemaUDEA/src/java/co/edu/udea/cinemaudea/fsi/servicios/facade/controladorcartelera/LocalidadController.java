...
import co.edu.udea.cinemaudea.fsi.persistencia.entidades.Localidad;
...
import co.edu.udea.cinemaudea.fsi.negocio.reserva.LocalidadFacade;
...
public class LocalidadController implements Serializable {
    ...
    @EJB
    private co.edu.udea.cinemaudea.fsi.negocio.reserva.LocalidadFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("LocalidadCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("LocalidadUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("LocalidadDeleted"));
        if (!JsfUtil.isValidationFailed()) {
