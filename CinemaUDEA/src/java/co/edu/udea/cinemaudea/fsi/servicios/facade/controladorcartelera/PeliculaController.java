...
import co.edu.udea.cinemaudea.fsi.persistencia.entidades.Pelicula;
...
import co.edu.udea.cinemaudea.fsi.negocio.cartelera.PeliculaFacade;
...
public class PeliculaController implements Serializable {
    ...
    @EJB
    private co.edu.udea.cinemaudea.fsi.negocio.cartelera.PeliculaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("PeliculaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("PeliculaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("PeliculaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
