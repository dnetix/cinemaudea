package co.edu.udea.cinemaudea.fsi.servicios.facade.controladorsocio;

import co.edu.udea.cinemaudea.fsi.persistencia.entidades.Socio;
...
import co.edu.udea.cinemaudea.fsi.negocio.socio.SocioFacade;
...
public class SocioController implements Serializable {
    ...
    @EJB
    private co.edu.udea.cinemaudea.fsi.negocio.socio.SocioFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("SocioCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("SocioUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("SocioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
