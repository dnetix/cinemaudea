package co.edu.udea.cinemaudea.fsi.servicios.facade.controladorcartelera;

import co.edu.udea.cinemaudea.fsi.persistencia.entidades.Cartelera;
...
import co.edu.udea.cinemaudea.fsi.negocio.cartelera.CarteleraFacade;
...
@ManagedBean(name = "carteleraController")
@SessionScoped
public class CarteleraController implements Serializable {

    @EJB
    private co.edu.udea.cinemaudea.fsi.negocio.cartelera.CarteleraFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("CarteleraCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("CarteleraUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("CarteleraDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    @FacesConverter(forClass = Cartelera.class)
